...
clang++ -c -g ..\src\ADT\*.cc -I ..\include\ADT

@REM This file used unsafe options as strcpy, strcat, etc. Clang give you a warning for each one, wich is a lot of messages, so I disable warnings while compiling this file.
