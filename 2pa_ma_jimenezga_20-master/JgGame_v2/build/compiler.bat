...
@REM cl /c /MDd /nologo /Zi /GR- /EHs ..\src\TFD\*.c -I ..\include\TFD
echo ---------------------------------------------------------------------------
echo.
echo ---------------------------------------------------------------------------
...
echo ----                             LINKING                                ---
echo --------------------------------------------------------------------------- 
cl /MDd /nologo /Zi /GR- /EHs /Fe..\bin\output.exe .\*.o ..\deps\SFML\lib\*.lib ..\deps\SQL\sqlite3.lib comdlg32.lib ole32.lib opengl32.lib user32.lib gdi32.lib shell32.lib Ws2_32.lib winmm.lib
echo.
